...
map.getView().fit([308707.379083, 7827041.073530, 3688659.556762, 12026211.837397], map.getSize());
    ...
    element: (() => {
        ...
        if (584 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'На данной карте представлены Топ 20 городов Норвегии по численности населения. Численность населения самих городов представлена в виде круга, который ещё в свою очередь, исходя из количества населения, приобретает определенный размер. Также на карте можно включить численность мужчин или женщин от численности всего населения городов. Численность мужчин и женщин также обозначается в виде круга, который также приобретает определенный размер, исходя из количества мужчин или женщин, в зависимости от того, что пользователь включит тот или иной параметр, чтобы он отображался на карте.';
            }
